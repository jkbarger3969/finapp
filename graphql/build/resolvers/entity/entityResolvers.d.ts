...
} & import("../../types").ContextBase, import("../../dataSources/accountingDb/types").BusinessDbRecord | import("../../dataSources/accountingDb/types").DepartmentDbRecord | import("../../graphTypes").Person>;
