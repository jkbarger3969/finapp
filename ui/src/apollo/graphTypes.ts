...
export type GetReportDataDeptFragment = { __typename: 'Department', id: string, name: string, disable: Array<{ __typename?: 'FiscalYear', id: string }>, budgets: Array<{ __typename: 'Budget', id: string, amount: string, fiscalYear: { __typename: 'FiscalYear', id: string } }> };
...
export type GetReportDataQuery = { __typename?: 'Query', department: { __typename: 'Department', id: string, name: string, descendants: Array<{ __typename: 'Department', id: string, name: string, disable: Array<{ __typename?: 'FiscalYear', id: string }>, budgets: Array<{ __typename: 'Budget', id: string, amount: string, fiscalYear: { __typename: 'FiscalYear', id: string } }> }>, disable: Array<{ __typename?: 'FiscalYear', id: string }>, budgets: Array<{ __typename: 'Budget', id: string, amount: string, fiscalYear: { __typename: 'FiscalYear', id: string } }> }, entries: Array<{ __typename: 'Entry', id: string, total: string, lastUpdate: string, deleted: boolean, refunds: Array<{ __typename: 'EntryRefund', id: string, total: string, deleted: boolean, lastUpdate: string }>, category: { __typename: 'Category', id: string, name: string, type: EntryType }, fiscalYear: { __typename: 'FiscalYear', id: string }, department: { __typename: 'Department', id: string, ancestors: Array<{ __typename: 'Business', id: string } | { __typename: 'Department', id: string }> }, items: Array<{ __typename: 'EntryItem', id: string, total: string, deleted: boolean, department?: { __typename: 'Department', id: string } | null | undefined }> }>, entryRefunds: Array<{ __typename: 'EntryRefund', id: string, total: string, deleted: boolean, lastUpdate: string, entry: { __typename: 'Entry', id: string, category: { __typename: 'Category', id: string, name: string, type: EntryType }, department: { __typename: 'Department', id: string, ancestors: Array<{ __typename: 'Business', id: string } | { __typename: 'Department', id: string }> } } }>, fiscalYears: Array<{ __typename: 'FiscalYear', id: string, name: string, begin: string, end: string }> };

export type GetFiscalYearsQueryVariables = Exact<{
  where?: InputMaybe<FiscalYearsWhere>;
}>;


export type GetFiscalYearsQuery = { __typename?: 'Query', fiscalYears: Array<{ __typename: 'FiscalYear', id: string, begin: string, end: string }> };
...
export type DepartmentInputOptFragment = { __typename: 'Department', id: string, name: string, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> };

export type DepartmentInputDefaultValueFragment = { __typename: 'Department', id: string, name: string, ancestors: Array<{ __typename: 'Business' } | { __typename: 'Department', id: string, name: string, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> }>, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> };
...
export type DepartmentInputDefaultValuesQuery = { __typename?: 'Query', departments: Array<{ __typename: 'Department', id: string, name: string, ancestors: Array<{ __typename: 'Business' } | { __typename: 'Department', id: string, name: string, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> }>, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> }> };
...
export type DepartmentInputOptsQuery = { __typename?: 'Query', departments: Array<{ __typename: 'Department', id: string, name: string, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> }> };

export type DepartmentInputFiscalYearQueryVariables = Exact<{
  where?: InputMaybe<FiscalYearsWhere>;
}>;


export type DepartmentInputFiscalYearQuery = { __typename?: 'Query', fiscalYears: Array<{ __typename: 'FiscalYear', id: string }> };
...
export type EntityInputOptsQuery = { __typename?: 'Query', entities: Array<{ __typename: 'Business', id: string, name: string, departments: Array<{ __typename: 'Department', id: string }> } | { __typename: 'Department', id: string, name: string, children: Array<{ __typename: 'Department', id: string }>, disable: Array<{ __typename: 'FiscalYear', id: string }> } | { __typename: 'Person', id: string, email?: string | null | undefined, phone?: string | null | undefined, personName: { __typename?: 'PersonName', first: string, last: string } }> };
