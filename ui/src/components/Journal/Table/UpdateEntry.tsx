...
const UpdateEntry = function (props: UpdateEntryProps) {
  ...
  const entryId = useSelector((state: Root) =>
    getUpdateId(state, entryUpsertId)
  );
  ...
  const onClickDelete = useCallback(
    (event?) => {
      deleteEntry({ variables: { id: entryId } })
        .then(() => {
  ...
  return (
    <Dialog maxWidth="lg" open={open}>
      <form>
        ...
        <Box justifyContent="center" display="flex" flexWrap="wrap" clone>
